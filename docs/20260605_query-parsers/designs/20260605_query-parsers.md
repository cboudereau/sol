...
> end of this document. Decision: [ADR 0042](../adrs/20260605_logql-traceql-parser-strategy.md).
...
Decisions:
- [ADR 0042 — Parser strategy: grmtools, porting the upstream goyacc grammar](../adrs/20260605_logql-traceql-parser-strategy.md)
