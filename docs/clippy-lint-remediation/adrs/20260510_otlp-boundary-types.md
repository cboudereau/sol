...
The [cast-safety-strategy](../../src-cast-remediation/adrs/20260510_cast-safety-strategy.md) ADR establishes that every
...
- **Exponential histogram bit math** (`(bits >> 52) as i32`,
  ...
  enclosing function per the [cast-safety-strategy](../../src-cast-remediation/adrs/20260510_cast-safety-strategy.md).
