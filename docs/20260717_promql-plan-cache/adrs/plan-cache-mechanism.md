...
Addresses: [FR2](../designs/promql-plan-cache.md#fr2), [NFR1](../designs/promql-plan-cache.md#nfr1), [NFR2](../designs/promql-plan-cache.md#nfr2)
...
**Blocked on [FR1](../designs/promql-plan-cache.md#fr1) data**: the 190 ms is not yet split across lowering / optimizer / physical planning / execution. Each bucket has a different best remedy. This ADR goes `proposed` when the profile lands.
