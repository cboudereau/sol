...
Refines: [file-layout-and-compaction-strategy](./file-layout-and-compaction-strategy.md), [deployment-roles-and-read-scaling](./deployment-roles-and-read-scaling.md)
