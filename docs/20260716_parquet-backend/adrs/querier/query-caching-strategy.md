...
Addresses: [FR5](../../designs/parquet-backend.md#fr5), [NFR6](../../designs/parquet-backend.md#nfr6) (response-time budget; supersedes the earlier NFR3 framing)
...
| C. No caching — rely on DataFusion's built-in optimizations | Simplest. No stale data risk. | Cannot meet the [NFR6](../../designs/parquet-backend.md#nfr6) latency budget for histogram quantile queries. Dashboard experience degrades. |
