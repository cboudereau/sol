...
Not yet in production → **clean cutover, no retro-compat or backfill** (regenerate the Parquet store, exactly as the [prom-name-column](../../prom-name-column/README.md) migration did).
