...
3. **Not crate versions**: the [tonic-stack-upgrade workspace](../../tonic-stack-upgrade/designs/20260518_tonic-stack-upgrade.md) researched tonic 0.13 / hyper 1.x / h2 0.4 and found no documented throughput improvement. hyper 1.x is an API redesign, not a performance release. tonic 0.13 is primarily a prost 0.13 update. The upgrade remains valuable for ecosystem hygiene but not for closing this gap.
...
The noop-traces-grpc-50k gap cannot be closed by application-level optimization or crate upgrades ([tonic-stack-upgrade research](../../tonic-stack-upgrade/designs/20260518_tonic-stack-upgrade.md) confirmed hyper 1.x and tonic 0.13 offer no throughput improvement). It requires:
