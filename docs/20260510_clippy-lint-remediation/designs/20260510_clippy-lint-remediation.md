...
[numeric conversion conventions ADR](../../20260510_src-cast-remediation/adrs/20260510_numeric-conversion-conventions.md)):
...
applies. See the
[ADR enforcement plan](../../20260510_src-cast-remediation/adrs/20260510_numeric-conversion-conventions.md) for details.
...
[typed boundary conversions](../adrs/20260510_otlp-boundary-types.md), and annotate
...
- Replaced with a [typed boundary conversion](../adrs/20260510_otlp-boundary-types.md)
...
| `cast_possible_truncation` | 49 | Boundary types (`OtlpCount`, `OtlpEnumField`) or function-level `#[expect]` — see [ADR](../adrs/20260510_otlp-boundary-types.md) |
...
| `cast_precision_loss` | 10 | `OtlpMetricInt::to_f64()` or local `#[expect]` for non-boundary casts — see [ADR](../adrs/20260510_otlp-boundary-types.md) |
...
[otlp-boundary-types ADR](../adrs/20260510_otlp-boundary-types.md)):
...
Decisions:
- [VRL ↔ OTLP cast safety strategy](../../20260510_src-cast-remediation/adrs/20260510_cast-safety-strategy.md)
- [Typed boundary conversions](../adrs/20260510_otlp-boundary-types.md)
- [Inherited lint policy](../adrs/20260510_inherited-lint-policy.md)
- [Numeric conversion conventions for sinks/sources/transforms](../../20260510_src-cast-remediation/adrs/20260510_numeric-conversion-conventions.md)
