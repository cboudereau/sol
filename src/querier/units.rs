...
//!
//! Per [ADR canonical-nanoseconds](../../docs/20260608_expr-lowering/adrs/20260608_canonical-nanoseconds.md):
...
/// `[5m]`/`offset` — the single duration parser ([FR7](../../docs/20260608_expr-lowering/designs/20260608_expr-lowering.md#fr7)).
///
